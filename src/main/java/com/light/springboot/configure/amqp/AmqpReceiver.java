...
public class AmqpReceiver {
    ...
    public void simpleReceive(String message){
        System.out.println("消费者1-->"+ "接收消息:" + message);
    }
    ...
    public void psReceive1(String message){
        System.out.println("消费者1-->"+ AmqpConfiguration.PS_QUEUE_1 + "接收消息:" + message);
    }
    /**
     * @Desc:   发布/订阅模式接收2
     * @Param:  [message]
    ...
    public void psReceive2(String message){
        System.out.println("消费者1-->"+ AmqpConfiguration.PS_QUEUE_2 + "接收消息:" + message);
    }
    ...
    public void routingReceive1(String routingKey,String message){
        System.out.println("消费者1-->"+ AmqpConfiguration.ROUTING_QUEUE_1 + "接收消息:" + message + "--> routingKey" + routingKey);
    }
    ...
    public void routingReceive2(String message){
        System.out.println("消费者1-->"+ AmqpConfiguration.ROUTING_QUEUE_2 + "接收消息:" + message);
    }
    ...
    public void topicReceive1(String message){
        System.out.println("消费者1-->"+ AmqpConfiguration.TOPIC_QUEUE_1 + "接收消息:" + message);
    }
    ...
    public void topicReceive2(String message){
        System.out.println("消费者1-->"+ AmqpConfiguration.TOPIC_QUEUE_2 + "接收消息:" + message);
    }
